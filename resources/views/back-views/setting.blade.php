    ...
    <div class="col-md-6">
        ...
        <div class="card">
            <div class="card-header ">
                <h5 class="text-center mt-2">App Name</h5>
            </div>
            <div class="card-body" style="padding: 20px">

                @php($config=\App\Helpers\Helper::get_app_settings('appName'))
                
                
                <form
                    action="{{route('setting.app',['appName'])}}"
                    method="post">
                    @csrf
                    @if(isset($config))
                        ...
                        <div class="form-group mb-2">
                            <label style="padding-left: 10px">App Name</label><br>
