...
<div class="col-md-12">
    ...
    <div class="block p-4">
        ...
        <div class="panel-title"><h3>Photo Gallery List</h3></div>
    ...
    <table class="table table-bordered table-striped table-vcenter js-dataTable-full" style="width:100%">
        ...
        @foreach($photoData as $data)
            <tr>
                ...
                <td>
                    <a href="{{route('photo.edit',$data->id)}}">
                    ...
                    <a class="btn btn-xs {{$data->status == 1 ? 'btn-success' :' btn-warning'}}"
                       href="{{route('photo.status',$data->id)}}"><i class="fa fa-refresh"></i></a>
                    <a href="{{route('photo.delete',$data->id)}}" data="{{$data->id}}"
